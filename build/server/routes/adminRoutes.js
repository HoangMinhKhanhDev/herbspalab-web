...
import { getAdminBlogs, getBlogById, getAdminComments, updateCommentStatus, deleteComment } from '../controllers/blogController.js';
import { getSettings, updateSettings } from '../controllers/settingsController.js';
import { protect, admin } from '../middleware/authMiddleware.js';
import { getCategories, createCategory, updateCategory, deleteCategory } from '../controllers/categoryController.js';
import { getAttributes, createAttribute, addAttributeValue, deleteAttribute, deleteAttributeValue } from '../controllers/attributeController.js';
const router = Router();
// Stats
